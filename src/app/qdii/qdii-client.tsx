...
const funds: Fund[] = [
  {name:'宝盈纳斯达克100指数A',code:'019736',category:'纳指100',wrapper:'场外申赎',structure:'指数型',share:'A',benchmark:'NASDAQ-100 Index',description:'跟踪纳斯达克市场100家大型非金融公司，成长与科技权重较高。',management:.50,custody:.15,service:0,total:.65,trackingError:'待更新',alipay:'200元/日',direct:'待更新',updated:'2026-09-19'},
  {name:'宝盈纳斯达克100指数C',code:'019737',category:'纳指100',wrapper:'场外申赎',structure:'指数型',share:'C',benchmark:'NASDAQ-100 Index',description:'与A类持仓一致，免申购费但持续收取销售服务费。',management:.50,custody:.15,service:.25,total:.90,trackingError:'待更新',alipay:'200元/日',direct:'待更新',updated:'2026-09-19'},
  {name:'万家纳斯达克100指数A',code:'019441',category:'纳指100',wrapper:'场外申赎',structure:'指数型',share:'A',benchmark:'NASDAQ-100 Index',description:'被动跟踪纳斯达克100，集中于大型科技、通信与消费成长公司。',management:.50,custody:.15,service:0,total:.65,trackingError:'待更新',alipay:'100元/日',direct:'待更新',updated:'2026-09-19'},
  ...
  {name:'汇添富纳斯达克100ETF联接A',code:'018966',category:'纳指100',wrapper:'场外申赎',structure:'指数型',share:'A',benchmark:'NASDAQ-100 Index',description:'主要通过目标ETF跟踪纳斯达克100，适合作为长期核心指数仓。',management:.50,custody:.15,service:0,total:.65,trackingError:'待更新',alipay:'低额度',direct:'1000元/日',updated:'2026-09-19'},
  {name:'汇添富纳斯达克100ETF联接E',code:'021773',category:'纳指100',wrapper:'场外申赎',structure:'指数型',share:'E',benchmark:'NASDAQ-100 Index',description:'与A/C类同一底层组合，免申购费并收取较低销售服务费。',management:.50,custody:.15,service:.10,total:.75,trackingError:'待更新',alipay:'待更新',direct:'1000元/日',updated:'2026-09-19'},
  ...
  {name:'国泰纳斯达克100指数',code:'160213',category:'纳指100',wrapper:'场外申赎',structure:'指数型',share:'A',benchmark:'NASDAQ-100 Index',description:'老牌纳指100指数QDII，历史较长但固定费率高于新一代产品。',management:.80,custody:.25,service:0,total:1.05,trackingError:'待更新',alipay:'100元/日',direct:'待更新',updated:'2026-09-19'},
  {name:'建信纳斯达克100指数A',code:'539001',category:'纳指100',wrapper:'场外申赎',structure:'指数型',share:'A',benchmark:'NASDAQ-100 Index',description:'被动跟踪纳斯达克100，当前费率和可申购额度均不占优势。',management:.80,custody:.20,service:0,total:1.00,trackingError:'待更新',alipay:'10元/日',direct:'待更新',updated:'2026-09-19'},
  {name:'景顺长城纳斯达克科技市值加权A',code:'017091',category:'纳指科技',wrapper:'场外申赎',structure:'指数型',share:'A',benchmark:'NASDAQ Technology Market Cap Weighted Index',description:'聚焦纳斯达克科技板块，较普通纳指100拥有更纯粹的科技暴露。',management:.80,custody:.20,service:0,total:1.00,trackingError:'待更新',alipay:'合计300元/日',direct:'合计1500元/日',updated:'2026-09-19'},
  ...
  {name:'景顺长城纳斯达克科技市值加权C',code:'017092',category:'纳指科技',wrapper:'场外申赎',structure:'指数型',share:'C',benchmark:'NASDAQ Technology Market Cap Weighted Index',description:'同一科技指数的C类份额，免申购费但长期持续费率更高。',management:.80,custody:.20,service:.40,total:1.40,trackingError:'待更新',alipay:'合计300元/日',direct:'合计1500元/日',updated:'2026-09-19'},
  {name:'摩根标普500指数A',code:'017641',category:'标普500',wrapper:'场外申赎',structure:'指数型',share:'A',benchmark:'S&P 500 Index',description:'覆盖500家大型上市公司，行业分散，是大盘核心指数暴露。',management:.50,custody:.15,service:0,total:.65,trackingError:'待更新',alipay:'10元/日',direct:'待更新',updated:'2026-09-19'},
  ...
  {name:'汇添富纳斯达克生物科技A',code:'017894',category:'生物科技',wrapper:'场外申赎',structure:'指数型',share:'A',benchmark:'NASDAQ Biotechnology Index',description:'集中于生物制药、创新药与生命科学公司，行业波动较高。',management:.50,custody:.15,service:0,total:.65,trackingError:'待更新',alipay:'100元/日',direct:'待更新',updated:'2026-09-19'},
...
export default function QdiiClient() {
  ...
  return <main className="qdii-page">
    ...
    <section className="qdii-summary">
      <article><small>精选基金</small><strong>{funds.length}</strong><span>第一批研究池</span></article>
    ...
    <section className="qdii-panel">
      ...
      <div className="qdii-table-wrap">
        <table className="qdii-table">
          <thead><tr><th>基金 / 代码</th><th>类型</th><th>份额</th><th>跟踪指数 / 比较基准</th><th>持仓解释</th><th>固定费率</th><th>跟踪误差</th><th>支付宝/代销</th><th>基金App直销</th></tr></thead>
          <tbody>{rows.map(f=><tr key={f.code+f.share}>
            <td><strong>{f.name}</strong><small>{f.code}</small></td>
            <td><span className="qdii-tag">{f.structure}</span><small>{f.wrapper}</small></td>
            <td><b>{f.share}</b></td>
      ...
      <footer className="qdii-note">限额以实际销售渠道下单页为准；费率为固定运作费口径（管理费 + 托管费 + 销售服务费），不含一次性申购/赎回费用。跟踪误差将在第二轮数据校验后补齐。</footer>
    </section>
  </main>;
}
