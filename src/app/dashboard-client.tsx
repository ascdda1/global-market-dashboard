...
export default function DashboardClient({ initialData }: { initialData: InitialDashboardData }) {
  ...
  const nav: Array<[string, string, BilingualLabel]> = [['#overview', '▦', moduleLabels.overview], ['#stocks', '⌁', moduleLabels.stocks], ['#etfs', '▤', moduleLabels.etfs], ['/dca', '◫', moduleLabels.dcaSimulation], ['/portfolio', '◉', { zh: '持仓模拟', en: 'Portfolio' }]];
